...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.button_middle_line_order, 3, 16, 1, 2)

        self.label_accelerate = QLabel(self.centralwidget)
        self.label_accelerate.setObjectName(u"label_accelerate")

        self.gridLayout.addWidget(self.label_accelerate, 1, 10, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_overlap, 2, 13, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_stay_time, 6, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.lineEdit_accelerate, 1, 13, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_selfdefine_calculate, 4, 6, 1, 1)

        self.lineEdit_group_count = QLineEdit(self.centralwidget)
        self.lineEdit_group_count.setObjectName(u"lineEdit_group_count")

        self.gridLayout.addWidget(self.lineEdit_group_count, 2, 17, 1, 2)
        ...
        self.gridLayout.addWidget(self.lineEdit_beam_speed_up, 2, 8, 1, 1)

        self.label_tips = QLabel(self.centralwidget)
        self.label_tips.setObjectName(u"label_tips")

        self.gridLayout.addWidget(self.label_tips, 3, 18, 1, 2)
        ...
        self.gridLayout.addWidget(self.button_animation_order, 3, 8, 1, 4)
        ...
        self.gridLayout.addWidget(self.button_animation_order_define, 4, 8, 1, 4)

        self.label_swing = QLabel(self.centralwidget)
        self.label_swing.setObjectName(u"label_swing")

        self.gridLayout.addWidget(self.label_swing, 6, 8, 1, 2)
        ...
        self.gridLayout.addWidget(self.button_middle_line_order_define, 4, 16, 1, 2)
        ...
        self.gridLayout.addWidget(self.button_simulation_order_define, 4, 12, 1, 4)

        self.lineEdit_num_set = QLineEdit(self.centralwidget)
        self.lineEdit_num_set.setObjectName(u"lineEdit_num_set")

        self.gridLayout.addWidget(self.lineEdit_num_set, 1, 17, 1, 2)
        ...
        self.gridLayout.addWidget(self.lineEdit_radius, 2, 2, 1, 2)
        ...
        self.gridLayout.addWidget(self.label_coefficient, 6, 17, 1, 1)

        self.label_num_set = QLabel(self.centralwidget)
        self.label_num_set.setObjectName(u"label_num_set")

        self.gridLayout.addWidget(self.label_num_set, 1, 16, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_efficient_calculate, 4, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_ceramic_width, 2, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.widget, 8, 1, 1, 19)
        ...
        self.gridLayout.addWidget(self.button_simulation_order, 3, 12, 1, 4)

        self.horizontalSpacer_2 = QSpacerItem(40, 20, QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Minimum)

        self.gridLayout.addItem(self.horizontalSpacer_2, 6, 20, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_middle, 7, 0, 1, 21)
        ...
        self.gridLayout.addWidget(self.label_top, 0, 0, 1, 21)
        ...
        self.gridLayout.addWidget(self.label_bottom, 9, 0, 1, 21)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.button_animation_order_define.setText(QCoreApplication.translate("MainWindow", u"\u8f68\u8ff9\u52a8\u753b\uff08\u81ea\uff09", None))
        self.label_swing.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"right\">\u6446\u5e45\uff1a</p></body></html>", None))
        self.button_middle_line_order_define.setText(QCoreApplication.translate("MainWindow", u"\u629b\u5149\u8f68\u8ff9\u66f2\u7ebf\uff08\u81ea\uff09", None))
        ...
        self.button_simulation_order_define.setText(QCoreApplication.translate("MainWindow", u"\u629b\u78e8\u91cf\u5206\u5e03\uff08\u81ea\uff09", None))

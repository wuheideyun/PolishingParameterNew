...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.lineEdit_beam_speed_up, 2, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_beam_speed_up, 2, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_num_set, 1, 14, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_num_set, 1, 15, 1, 2)

        self.lineEdit_group_count = QLineEdit(self.centralwidget)
        self.lineEdit_group_count.setObjectName(u"lineEdit_group_count")

        self.gridLayout.addWidget(self.lineEdit_group_count, 2, 15, 1, 2)

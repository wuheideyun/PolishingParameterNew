...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.button_animation_order, 3, 8, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_animation_order_define, 4, 8, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_simulation_order, 3, 10, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_middle_line_order, 3, 13, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_middle_line_order_define, 4, 13, 1, 1)

        self.label_tips = QLabel(self.centralwidget)
        self.label_tips.setObjectName(u"label_tips")
        self.label_tips.setMaximumSize(QSize(180, 16777215))

        self.gridLayout.addWidget(self.label_tips, 3, 16, 1, 3)

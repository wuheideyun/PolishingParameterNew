...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.button_simulation_order, 3, 10, 1, 4)

        self.lineEdit_overlap = QLineEdit(self.centralwidget)
        self.lineEdit_overlap.setObjectName(u"lineEdit_overlap")

        self.gridLayout.addWidget(self.lineEdit_overlap, 2, 13, 1, 2)
        ...
        self.gridLayout.addWidget(self.label_accelerate, 1, 11, 1, 2)
        ...
        self.gridLayout.addWidget(self.label_middle, 7, 0, 1, 18)
        ...
        self.gridLayout.addWidget(self.button_simulation_order_define, 4, 10, 1, 4)
        ...
        self.gridLayout.addWidget(self.lineEdit_ceramic_width, 2, 4, 1, 3)
        ...
        self.gridLayout.addWidget(self.label_top, 0, 0, 1, 18)
        ...
        self.gridLayout.addWidget(self.label_coefficient, 6, 15, 1, 1)

        self.lineEdit_belt_speed = QLineEdit(self.centralwidget)
        self.lineEdit_belt_speed.setObjectName(u"lineEdit_belt_speed")

        self.gridLayout.addWidget(self.lineEdit_belt_speed, 1, 9, 1, 2)
        ...
        self.gridLayout.addWidget(self.button_middle_line_order_define, 4, 14, 1, 2)

        self.lineEdit_swing = QLineEdit(self.centralwidget)
        self.lineEdit_swing.setObjectName(u"lineEdit_swing")

        self.gridLayout.addWidget(self.lineEdit_swing, 6, 8, 1, 2)
        ...
        self.gridLayout.addWidget(self.lineEdit_beam_speed_up, 2, 9, 1, 2)
        ...
        self.gridLayout.addWidget(self.label_tips, 3, 16, 1, 2)
        ...
        self.gridLayout.addWidget(self.button_animation_order_define, 4, 6, 1, 4)
        ...
        self.gridLayout.addWidget(self.lineEdit_self_delay_time, 6, 5, 1, 1)

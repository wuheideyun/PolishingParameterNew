...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.label_beam_swing_speed, 4, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_stay_time, 5, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_middle, 7, 0, 1, 12)
        ...
        self.gridLayout.addWidget(self.label_bottom, 9, 0, 1, 12)
        ...
        self.gridLayout.addWidget(self.button_energy_calculate, 3, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_ceramic_width, 2, 5, 1, 2)
        ...
        self.gridLayout.addWidget(self.button_efficient_calculate, 3, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_beam_constant_time, 5, 8, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_beam_constant_time, 5, 7, 1, 1)

        self.widget = QWidget(self.centralwidget)
        self.widget.setObjectName(u"widget")
        self.widget.setStyleSheet(u"background-color: rgb(244, 244, 244);")

        self.gridLayout.addWidget(self.widget, 8, 1, 1, 10)
        ...
        self.gridLayout.addWidget(self.label_swing, 4, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_radius, 2, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_simulation_equal, 4, 10, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_beam_swing_speed, 4, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_num, 6, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_middle_line_equal, 5, 10, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_swing, 4, 8, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_num, 6, 4, 1, 1)

        self.label_stay_time = QLabel(self.centralwidget)
        self.label_stay_time.setObjectName(u"label_stay_time")

        self.gridLayout.addWidget(self.label_stay_time, 5, 4, 1, 1)
        ...
        self.lable_beam_accelerate_time = QLabel(self.centralwidget)
        self.lable_beam_accelerate_time.setObjectName(u"lable_beam_accelerate_time")

        self.gridLayout.addWidget(self.lable_beam_accelerate_time, 2, 7, 1, 1)

        self.lineEdit_beam_accelerate_time = QLineEdit(self.centralwidget)
        self.lineEdit_beam_accelerate_time.setObjectName(u"lineEdit_beam_accelerate_time")

        self.gridLayout.addWidget(self.lineEdit_beam_accelerate_time, 2, 8, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.button_simulation_equal.setText(QCoreApplication.translate("MainWindow", u"\u629b\u78e8\u91cf\u5206\u5e03", None))
        self.button_middle_line_equal.setText(QCoreApplication.translate("MainWindow", u"\u629b\u5149\u8f68\u8ff9\u66f2\u7ebf", None))
        self.label_coefficient.setText(QCoreApplication.translate("MainWindow", u"\u5747\u5300\u7cfb\u6570", None))
        self.button_animation_equal.setText(QCoreApplication.translate("MainWindow", u"\u8f68\u8ff9\u52a8\u753b", None))
        ...
        self.lable_beam_accelerate_time.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\">\u6a2a\u6881\u52a0\u901f\u65f6\u95f4\uff1a</p></body></html>", None))
    # retranslateUi

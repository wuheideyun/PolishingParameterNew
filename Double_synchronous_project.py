...
def data_figure_plot(v1,v2,constant_time,stay_time,ceramic_width,between,beam_between,num,R,a,mo):
    # 抛磨量分布子程序
    r_P_d = Polishing_distribution_Thread_equal(v1, v2, constant_time, stay_time, a, between,beam_between, num, R, mo)
    result_P_d_matrix,result_P_d_par = r_P_d.emit()
    # 轨迹中心线分布
    m_l_p = middle_line_plot_equal(v1,v2,constant_time,stay_time,a,num,between,beam_between)
...
def polishing_cal(begin,end,v1,v2,constant_t,stay_t,a,R,mod_rho,mod_theta,mo):
    ...
    return H
# 抛磨量分布，子工作线程
class Polishing_distribution_Thread_equal():

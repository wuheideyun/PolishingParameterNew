...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.lineEdit_beam_constant_time, 1, 9, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_middle_line_equal, 4, 6, 1, 2)

        self.label_beam_swing_speed = QLabel(self.centralwidget)
        self.label_beam_swing_speed.setObjectName(u"label_beam_swing_speed")

        self.gridLayout.addWidget(self.label_beam_swing_speed, 2, 5, 1, 2)
        ...
        self.gridLayout.addWidget(self.button_simulation_order, 5, 4, 1, 2)
        ...
        self.gridLayout.addWidget(self.button_simulation_equal, 4, 4, 1, 2)
        ...
        self.gridLayout.addWidget(self.lineEdit_stay_time, 2, 9, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_beam_constant_time, 1, 8, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_animation_equal, 4, 3, 1, 1)

        self.label_belt_speed = QLabel(self.centralwidget)
        self.label_belt_speed.setObjectName(u"label_belt_speed")

        self.gridLayout.addWidget(self.label_belt_speed, 1, 5, 1, 2)
        ...
        self.gridLayout.addWidget(self.button_animation_cross, 6, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_simulation_cross, 6, 4, 1, 2)
        ...
        self.gridLayout.addWidget(self.button_animation_order, 5, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_middle_line_order, 5, 6, 1, 2)

        self.lineEdit_num = QLineEdit(self.centralwidget)
        self.lineEdit_num.setObjectName(u"lineEdit_num")

        self.gridLayout.addWidget(self.lineEdit_num, 3, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.widget, 8, 1, 1, 9)
        ...
        self.gridLayout.addWidget(self.button_middle_line_cross, 6, 6, 1, 2)

        self.label_num = QLabel(self.centralwidget)
        self.label_num.setObjectName(u"label_num")

        self.gridLayout.addWidget(self.label_num, 3, 5, 1, 2)
        ...
        self.gridLayout.addWidget(self.label_stay_time, 2, 8, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_coefficient, 3, 9, 1, 1)

        self.horizontalSpacer_2 = QSpacerItem(40, 20, QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Minimum)

        self.gridLayout.addItem(self.horizontalSpacer_2, 2, 10, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_bottom, 9, 0, 1, 11)

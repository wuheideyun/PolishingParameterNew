...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.label_beam_constant_time, 0, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_beam_constant_time, 0, 8, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_cerimatic_width, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_ceramic_width, 1, 3, 1, 1)

        self.label_beam_swing_speed = QLabel(self.centralwidget)
        self.label_beam_swing_speed.setObjectName(u"label_beam_swing_speed")

        self.gridLayout.addWidget(self.label_beam_swing_speed, 1, 4, 1, 2)
        ...
        self.gridLayout.addWidget(self.button_animation_equal, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_simulation_equal, 3, 3, 1, 2)
        ...
        self.gridLayout.addWidget(self.button_middle_line_equal, 3, 5, 1, 2)
        ...
        self.gridLayout.addWidget(self.button_animation_order, 4, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_simulation_order, 4, 3, 1, 2)
        ...
        self.gridLayout.addWidget(self.button_middle_line_order, 4, 5, 1, 2)
        ...
        self.gridLayout.addWidget(self.button_animation_cross, 5, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_simulation_cross, 5, 3, 1, 2)
        ...
        self.gridLayout.addWidget(self.button_middle_line_cross, 5, 5, 1, 2)

        self.widget = QWidget(self.centralwidget)
        self.widget.setObjectName(u"widget")
        self.widget.setStyleSheet(u"background-color: rgb(0, 170, 255);")

        self.gridLayout.addWidget(self.widget, 6, 0, 1, 9)

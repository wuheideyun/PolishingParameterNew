...
# ——————————————出图程序（主程序）———————————————
def data_figure_plot(v1,ceramic_width,beam_between,R,a,mo):
    # 抛磨量分布子程序
    result = single_num_calculate(v1,ceramic_width,beam_between,R,a)
    v2 = result[0,1]
    constant_time =result[0,2]
    stay_time =result[0,3]
    num = math.ceil(result[0,4])
    ...
    ax_2.set_xlim((-200, period * 3 * v1 + 3*between))
...
if __name__ == '__main__':
    data_figure_plot(300,900,900,270,650,140)
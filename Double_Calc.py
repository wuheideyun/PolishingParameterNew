...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.label_accelate_speed, 1, 8, 1, 1)

        self.lineEdit_overlap = QLineEdit(self.centralwidget)
        self.lineEdit_overlap.setObjectName(u"lineEdit_overlap")

        self.gridLayout.addWidget(self.lineEdit_overlap, 3, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.lineEdit_constant_time, 13, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.Button_selfdefine_calculate, 4, 10, 1, 1)

        self.label_group = QLabel(self.centralwidget)
        self.label_group.setObjectName(u"label_group")

        self.gridLayout.addWidget(self.label_group, 4, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_a_speed, 1, 10, 1, 1)

        self.lineEdit_beam_speed = QLineEdit(self.centralwidget)
        self.lineEdit_beam_speed.setObjectName(u"lineEdit_beam_speed")

        self.gridLayout.addWidget(self.lineEdit_beam_speed, 13, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_beam_speed, 13, 3, 1, 2)
        ...
        self.gridLayout.addWidget(self.label_cerimatic_width, 2, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_gap, 1, 0, 1, 1)

        self.label_overlap = QLabel(self.centralwidget)
        self.label_overlap.setObjectName(u"label_overlap")

        self.gridLayout.addWidget(self.label_overlap, 3, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_beam_speed_up, 4, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_beam_speed_up, 4, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.widget, 10, 0, 1, 13)
        ...
        self.gridLayout.addWidget(self.lineEdit_group, 4, 8, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_mod_size, 1, 3, 1, 1)

...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.lineEdit_overlap, 2, 11, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_animation_order, 6, 6, 1, 1)

        self.lineEdit_between_beam = QLineEdit(self.centralwidget)
        self.lineEdit_between_beam.setObjectName(u"lineEdit_between_beam")

        self.gridLayout.addWidget(self.lineEdit_between_beam, 2, 2, 1, 2)
        ...
        self.gridLayout.addWidget(self.lineEdit_num, 13, 9, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_delay_time, 14, 9, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_energy_calculate, 4, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_beam_speed_up, 3, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_save_parameter, 4, 1, 1, 1)

        self.label_stay_time = QLabel(self.centralwidget)
        self.label_stay_time.setObjectName(u"label_stay_time")

        self.gridLayout.addWidget(self.label_stay_time, 14, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.lineEdit_beam_constant_time, 13, 3, 1, 1)

        self.label_grind_size = QLabel(self.centralwidget)
        self.label_grind_size.setObjectName(u"label_grind_size")

        self.gridLayout.addWidget(self.label_grind_size, 1, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_self_delay_time, 14, 11, 1, 1)

        self.label_self_define_num = QLabel(self.centralwidget)
        self.label_self_define_num.setObjectName(u"label_self_define_num")

        self.gridLayout.addWidget(self.label_self_define_num, 3, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_beam_swing_speed, 13, 6, 1, 1)

        self.label_overlap = QLabel(self.centralwidget)
        self.label_overlap.setObjectName(u"label_overlap")

        self.gridLayout.addWidget(self.label_overlap, 2, 9, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_swing, 14, 6, 1, 1)

        self.label_between = QLabel(self.centralwidget)
        self.label_between.setObjectName(u"label_between")

        self.gridLayout.addWidget(self.label_between, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_beam_constant_time, 13, 1, 1, 2)

        self.label_num = QLabel(self.centralwidget)
        self.label_num.setObjectName(u"label_num")

        self.gridLayout.addWidget(self.label_num, 13, 8, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_self_define_num, 3, 8, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_accelerate, 1, 9, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_middle_line_order_define, 6, 9, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_simulation_order_define, 6, 11, 1, 1)

        self.widget = QWidget(self.centralwidget)
        self.widget.setObjectName(u"widget")
        self.widget.setStyleSheet(u"background-color: rgb(244, 244, 244);")

        self.gridLayout.addWidget(self.widget, 10, 1, 1, 11)
        ...
        self.gridLayout.addWidget(self.button_selfdefine_calculate, 4, 9, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_group_count, 4, 7, 1, 1)

        self.label_radius = QLabel(self.centralwidget)
        self.label_radius.setObjectName(u"label_radius")

        self.gridLayout.addWidget(self.label_radius, 2, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_efficient_calculate, 4, 4, 1, 1)

        self.label_beam_swing_speed = QLabel(self.centralwidget)
        self.label_beam_swing_speed.setObjectName(u"label_beam_swing_speed")

        self.gridLayout.addWidget(self.label_beam_swing_speed, 13, 4, 1, 2)

        self.horizontalSpacer_2 = QSpacerItem(40, 20, QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Minimum)

        self.gridLayout.addItem(self.horizontalSpacer_2, 2, 12, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_top, 0, 0, 1, 13)
        ...
        self.gridLayout.addWidget(self.label_middle, 7, 0, 1, 13)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.button_animation_order.setText(QCoreApplication.translate("MainWindow", u"\u8f68\u8ff9\u52a8\u753b", None))
        ...
        self.button_energy_calculate.setText(QCoreApplication.translate("MainWindow", u"\u8282\u80fd\u65b9\u6848", None))
        ...
        self.label_self_define_num.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"right\">\u8bbe\u5b9a\u5168\u8986\u76d6\u78e8\u5934\u6570\uff1a</p></body></html>", None))
        self.button_middle_line_order.setText(QCoreApplication.translate("MainWindow", u"\u629b\u5149\u8f68\u8ff9\u66f2\u7ebf", None))
        ...
        self.button_middle_line_order_define.setText(QCoreApplication.translate("MainWindow", u"\u629b\u5149\u8f68\u8ff9\u66f2\u7ebf\uff08\u81ea\u5b9a\u4e49\uff09", None))
        self.button_simulation_order_define.setText(QCoreApplication.translate("MainWindow", u"\u6446\u629b\u78e8\u91cf\u5206\u5e03(\u81ea\u5b9a\u4e49)", None))
        self.button_selfdefine_calculate.setText(QCoreApplication.translate("MainWindow", u"\u81ea\u5b9a\u4e49\u4fee\u6b63\u65b9\u6848", None))
        self.button_simulation_order.setText(QCoreApplication.translate("MainWindow", u"\u629b\u78e8\u91cf\u5206\u5e03", None))
        ...
        self.button_efficient_calculate.setText(QCoreApplication.translate("MainWindow", u"\u9ad8\u54c1\u8d28\u65b9\u6848", None))

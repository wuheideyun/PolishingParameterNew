...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.label_coefficient, 3, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_grind_size, 1, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_accelerate, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_middle_line_equal, 6, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.widget, 7, 1, 1, 7)
        ...
        self.gridLayout.addWidget(self.lineEdit_coefficient, 3, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_beam_swing_speed, 4, 2, 1, 2)
        ...
        self.gridLayout.addWidget(self.button_simulation_equal, 6, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_beam_constant_time, 4, 4, 1, 1)

        self.label_radius = QLabel(self.centralwidget)
        self.label_radius.setObjectName(u"label_radius")

        self.gridLayout.addWidget(self.label_radius, 1, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_middle, 5, 0, 1, 9)
        ...
        self.gridLayout.addWidget(self.label_bottom, 8, 0, 1, 9)

...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.num, 2, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.equal_coefficient, 4, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.grind_size, 1, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.belt_speed, 3, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.radius, 1, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.between, 1, 1, 1, 2)

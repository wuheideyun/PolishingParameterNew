...
# ——————————————出图程序（主程序）———————————————
def data_figure_plot(v1,v2,constant_time,stay_time,delay_time,ceramic_width,between,beam_between,num,R,a,mo):
    # 抛磨量分布子程序
...
if __name__ == '__main__':
    data_figure_plot(300,500,1,1.8,1,900,600,1900,6,270,650,140)
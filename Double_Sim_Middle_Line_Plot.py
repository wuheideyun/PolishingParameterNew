...
class middle_line_plot_equal():
    ...
    def figure_plot(self):
        ...
        for i in range(0, num_two):
            plt.scatter(single_X_location+ i * self.between_beam,single_Y_location,color=color_7[i],s=1)
            plt.scatter(single_X_location + i * self.between_beam + self.between,single_Y_location,color=color_7[i],s=1)
        plt.show()  # 显示函数图像

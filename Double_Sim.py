...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.label_delay_time, 3, 5, 1, 1)

        self.lineEdit_radius = QLineEdit(self.centralwidget)
        self.lineEdit_radius.setObjectName(u"lineEdit_radius")

        self.gridLayout.addWidget(self.lineEdit_radius, 4, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_belt_speed, 1, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_beam_swing_speed, 2, 3, 1, 1)

        self.label_num = QLabel(self.centralwidget)
        self.label_num.setObjectName(u"label_num")

        self.gridLayout.addWidget(self.label_num, 4, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_stay_time, 2, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_beam_constant_time, 1, 6, 1, 1)

        self.label_radius = QLabel(self.centralwidget)
        self.label_radius.setObjectName(u"label_radius")

        self.gridLayout.addWidget(self.label_radius, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_beam_swing_speed, 2, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_delay_time, 3, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_middle, 9, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.label_top, 0, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.button_save_parameter, 5, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_animation_equal, 6, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_animation_cross, 6, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_middle_line_cross, 8, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_middle_line_order, 8, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_simulation_order, 7, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_simulation_equal, 7, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_middle_line_equal, 8, 3, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\">\u4ea4\u53c9\u6446\u6a21\u5f0f</p></body></html>", None))
        self.label_belt_speed.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>\u76ae\u5e26\u901f\u5ea6\uff1a</p></body></html>", None))
        self.label.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\">\u540c\u6b65\u6446\u6a21\u5f0f</p></body></html>", None))
        ...
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\">\u987a\u5e8f\u6446\u6a21\u5f0f</p></body></html>", None))
        ...
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\">\u52a8\u753b\u6a21\u62df</p></body></html>", None))
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\">\u629b\u78e8\u91cf\u5206\u5e03\u6a21\u62df</p></body></html>", None))
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\">\u8f68\u8ff9\u66f2\u7ebf\u6a21\u62df</p></body></html>", None))
        self.button_animation_cross.setText(QCoreApplication.translate("MainWindow", u"\u8f68\u8ff9\u52a8\u753b\uff08\u4ea4\uff09", None))
        self.button_animation_order.setText(QCoreApplication.translate("MainWindow", u"\u8f68\u8ff9\u52a8\u753b\uff08\u987a\uff09", None))

...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.button_animation_order, 7, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_middle_line_equal, 6, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_accelerate, 3, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_save_parameter, 6, 2, 1, 1)

        self.lineEdit_coefficient = QLineEdit(self.centralwidget)
        self.lineEdit_coefficient.setObjectName(u"lineEdit_coefficient")

        self.gridLayout.addWidget(self.lineEdit_coefficient, 4, 8, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_animation_cross, 8, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_coefficient, 4, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_delay_time, 3, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_simulation_equal, 6, 4, 1, 3)
        ...
        self.gridLayout.addWidget(self.button_middle_line_order, 7, 7, 1, 1)

        self.lineEdit_num = QLineEdit(self.centralwidget)
        self.lineEdit_num.setObjectName(u"lineEdit_num")

        self.gridLayout.addWidget(self.lineEdit_num, 4, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_simulation_order, 7, 4, 1, 3)
        ...
        self.gridLayout.addWidget(self.button_simulation_cross, 8, 4, 1, 3)
        ...
        self.gridLayout.addWidget(self.button_middle_line_cross, 8, 7, 1, 1)
        ...
        self.gridLayout.addItem(self.horizontalSpacer_2, 3, 9, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_middle, 9, 0, 1, 10)
        ...
        self.gridLayout.addWidget(self.label_bottom, 11, 0, 1, 10)

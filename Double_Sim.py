...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.label_beam_swing_speed, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_num, 4, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_num, 4, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_save_parameter, 6, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_accelerate, 3, 5, 1, 1)

        self.label_belt_speed = QLabel(self.centralwidget)
        self.label_belt_speed.setObjectName(u"label_belt_speed")

        self.gridLayout.addWidget(self.label_belt_speed, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_beam_constant_time, 1, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_beam_constant_time, 1, 6, 1, 1)

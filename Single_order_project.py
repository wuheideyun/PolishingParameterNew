...
# ——————————————出图程序（主程序）———————————————
def data_figure_plot(v1, v2, constant_time, stay_time,ceramic_width,a,beam_between, num, R, mo,delay_time):

    r_P_d = Polishing_distribution_order(v1, v2, constant_time, stay_time, a,beam_between, num, R, mo,delay_time)
    result_P_d_matrix,result_P_d_par = r_P_d.emit()
    # 轨迹中心线分布
    m_l_p = middle_line_plot_order(v1, v2, constant_time, stay_time, a, num, beam_between,delay_time)
    ...
    #ax_2.scatter(single_X_location,single_Y_location)
...
def polishing_cal(begin,end,v1,v2,constant_t,stay_t,a,R,mod_rho,mod_theta,mo):
    ...
    return H
class Polishing_distribution_order():
    def __init__(self,v1, v2, constant_time, stay_time, a,beam_between, num, R, mo,delay_time):
        # 变量赋值
        self.v1 = v1
        self.v2 = v2
    ...
    def matrix_cal(self, H_all):
        ...
        begin_length = math.ceil((50 + self.v1 * 4 * self.period) / 10)
...
if __name__ == '__main__':
    data_figure_plot(300, 500, 1, 0.8,900,650, 900, 5, 270, 140,1)